...
@section('content')
    ...
    <div class="col-md-12">
        <div class="col-md-8">
            {!! Form::open(array('method' => 'PATCH' ,'route' => ['QA.update', $oldQuestion->id], 'class' => 'form') ) !!}
            <div class="form-group" , style="margin-top: 4%">
                {!! Form::label('Başlık :') !!}
                {!! Form::text('title', $oldQuestion->title, array('required', 'class'=>'form-control', 'placeholder'=>'Başlık')) !!}
            </div>
            <div class="form-group">
                {!! Form::label('Etiket :') !!}
                {!! Form::text('tags', $oldQuestion->tags, array('id'=>'tags', 'required', 'class'=>'form-control', 'placeholder'=>'Etiket')) !!}
            </div>
            <div class="form-group">
                {!! Form::label('Sorunuz:') !!}
                {!! Form::textarea('question', $oldQuestion->question, array('id' => 'questionText', 'required',  'class'=>'form-control',  'placeholder'=>'Sorunuz')) !!}
            </div>
