            ...
            <section class="col-md-8">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <a href="single_blog_page.html">
                                <img src="../resources/assets/img/corporate.jpg" class="img-thumbnail center-block"
                ...
                <article class="blog-item">
                    <div class="row">
                        <div class="col-md-3">
                            <a href="#">
                                <img src="../resources/assets/img/restaurant.jpg" class="img-thumbnail center-block"
                                     alt="Blog Post Thumbnail">
                            </a>
                        </div>
                        <div class="col-md-9">
                ...
                <article class="blog-item">
                    <div class="row">
                        <div class="col-md-3">
                            <a href="#">
                                <img src="../resources/assets/img/coming-soon.jpg" class="img-thumbnail center-block"
                                     alt="Blog Post Thumbnail">
                            </a>
                        </div>
                        <div class="col-md-9">
                            ...
                            <h1>
                                <a href="single_blog_page.html">50+ best free responsive coming soon template in
                                    2015</a>
                            </h1>
                        </div>
                    </div>
                ...
                <article class="blog-item">
                    <div class="row">
                        <div class="col-md-3">
                            <a href="#">
                                <img src="../resources/assets/img/photography.jpg" class="img-thumbnail center-block"
                                     alt="Blog Post Thumbnail">
                            </a>
                        </div>
                        <div class="col-md-9">
                            ...
                            <h1>
                                <a href="single_blog_page.html">50+ best free responsive photography template in
                                    2015</a>
                            </h1>
                        </div>
                    </div>
            ...
            <aside class="col-md-4 col-sm-8 col-xs-8">
                <div class="sidebar">
                    ...
                    <a href="http://themewagon.com/" class="template-images">
                        <img class="img-responsive" src="../resources/assets/img/store1.png" alt="Template Store">
