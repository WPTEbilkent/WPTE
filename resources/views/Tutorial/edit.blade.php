...
@section('content')
    ...
    <div class="col-md-12">
        <div class="col-md-8">
            {!! Form::open(array('method' => 'PATCH' ,'route' => ['tutorial.update', $oldTutorial->id], 'class' => 'form') ) !!}

            <div class="form-group", style="margin-top: 4%">
                {!! Form::label('Başlık :') !!}
                {!! Form::text('title', $oldTutorial->title, array('required', 'class'=>'form-control', 'placeholder'=>'Başlık')) !!}
            </div>
            <div class="form-group">
                {!! Form::label('Etiket :') !!}
                {!! Form::text('tags', $oldTutorial->tags, array('id'=>'tags', 'required', 'class'=>'form-control', 'placeholder'=>'Etiket')) !!}
            </div>
            <div class="form-group">
                {!! Form::label('İçeriğiniz :') !!}
                {!! Form::textarea('content', $oldTutorial->content, array('id' => 'tutorialText', 'required',  'class'=>'form-control',  'placeholder'=>'Mesaj')) !!}
            </div>
