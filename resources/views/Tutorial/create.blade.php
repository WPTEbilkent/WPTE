@extends('layouts.masterTutorialCreate')
@extends('HeadFoot')
@section('content')
                ...
                <div class="form-group" , style="margin-top: 4%">
                    ...
                    <div class="textarea margin-15-b rounded bordered light-bordered dual-bordered ease-form">
                        ...
                        @if(Session::has('old_val_text'))
                            {!! Form::textarea('content', Session::get('old_val_text'), array('id' => 'tutorialText', 'required',  'class'=>'form-control',  'placeholder'=>'Sorunuz')) !!}
                        @else
                            {!! Form::textarea('content', null, array('id' => 'tutorialText', 'required',  'class'=>'form-control',  'placeholder'=>'Sorunuz')) !!}
                        @endif
                        {{--                        {!! Form::textarea('content', null, array('id' => 'tutorialText', 'required',  'class'=>'form-control',  'placeholder'=>'Sorunuz')) !!}--}}
                    </div>
