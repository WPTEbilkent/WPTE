        ...
        <div class="row">
            <div class="col-static">
                <div class="static-184 md-align-center">
                    <a class="youtestify-logo" href="index.php"><img class="retina" src="img/logo.png" alt="Youtestify"></a>
                </div>
                    ...
                    <div class="col-12">
                        <nav class="header-nav">
                            ...
                            <ul class="list-custom theme-night ui-dark ease-opacity">
                                ...
                                <li><a class="ease-link" href="#"><span class="ease-color">GİRİŞ<span></a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
